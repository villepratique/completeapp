...
class Bon(models.Model):
    ...
    priceHT = models.DecimalField(decimal_places=2 , max_digits=7 , verbose_name="Montant H.T. (par mise en ligne)" , blank=True , null=True)
    tva = models.DecimalField(decimal_places=2 , max_digits=7 , verbose_name="Tva" , blank=True , null=True)
    # tva = models.DecimalField(decimal_places=2)
    totalTTC = models.DecimalField(decimal_places=2 , max_digits=7 , verbose_name="Total T.T.C. (par mise en ligne)" , blank=True , null=True)
    totalHT = models.DecimalField(decimal_places=2 , max_digits=7 , verbose_name="Total H.T. (de la campagne)" , blank=True , null=True)
